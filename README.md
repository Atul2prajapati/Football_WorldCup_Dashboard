...
🚀 Excited to share my latest data analytics project — FIFA World Cup 2022 Interactive Football Dashboard! ⚽📊

As someone deeply passionate about both data engineering and football, I decided to combine the two into a full end-to-end analytics project — and I'm thrilled with how it came together.

---

🔍 What I built:

An interactive Power BI dashboard analyzing the Top 20 national football teams using FIFA World Cup 2022 data — with dynamic filters, historical insights, and player-level tactical analysis.

---

🛠️ What went into it:

→ Web scraping Wikipedia with Python (BeautifulSoup + Requests) to extract historical World Cup records
→ Data wrangling with Pandas — cleaning nulls, normalizing columns, and structuring the data
→ SQLite database to store cleaned data in a relational structure using Python's sqlite3 module
→ SQL queries (GROUP BY, SUM, CASE WHEN) to aggregate KPIs like total goals, win rates, and match counts before exporting to CSV
→ Power Query (M Language) for ETL transformations inside Power BI
→ DAX measures for advanced KPIs like win rates, goals contribution, and performance rankings
→ Radar charts for player-level profiling across passes, assists, goals & touches
→ Base64 encoding to seamlessly embed national team flags as visuals
→ 2026 World Cup fixture integration for forward-looking analysis

---

📈 Key features of the dashboard:

✅ Dynamic multi-team selection & comparison
✅ Historical World Cup wins/losses across all editions
✅ Attacking strength & goals analysis
✅ Recent form tracker (last 5 matches)
✅ FIFA World Ranking benchmarking
✅ Player radar charts for tactical insights

---

💡 What I learned:

This project pushed me to think beyond just visualizations — I had to build the entire data pipeline from scratch. From scraping raw HTML tables off Wikipedia, to storing and querying data with SQL inside a SQLite database, to modeling relationships in Power BI's data model — every layer taught me something new about real-world data engineering.

One thing that genuinely surprised me: using SQL as an intermediate layer between Pandas and Power BI made the whole pipeline cleaner and more structured. Aggregating with GROUP BY and CASE WHEN before the data even reaches Power BI meant less heavy lifting in DAX later.

The biggest challenge? Getting the image integration right using Base64 encoding. Small detail, huge visual impact. 🎨

---

🔗 The full project, code, and documentation are live on my GitHub — link in the comments below!

If you're into data analytics, football, or both — I'd love to hear your thoughts. Drop a comment, share it with someone who'd find it useful, or connect if you'd like to collaborate! 🙌

---

#DataAnalytics #PowerBI #Python #SQL #SQLite #FootballAnalytics #DataEngineering #DAX #DataVisualization #FIFA #WorldCup2022 #DataScience #BusinessIntelligence #OpenSource #GitHub #Analytics #Football #SportsAnalytics #PandasPython #WebScraping #DataProjects #DataPipeline
